...
(let* ((bg "#1a231a")
      ...
      (on-primary "#1b221b")
      (on-primary-container "#e0ebe0")
      (on-secondary "#1b221b")
      (on-secondary-container "#e1eae6")
      (on-surface "#f2f3f2")
      (on-surface-variant "#afb6af")
      (on-tertiary "#1b221b")
      (on-tertiary-container "#e1eaea")
      (outline-color "#5f6f5f")
      (outline-variant "#5a725a")
      (primary "#8bc18b")
      (primary-container "#2f6a2f")
      (secondary "#81b199")
      (secondary-container "#2c5440")
      (shadow "#1a231a")
      (surface "#1a231a")
      (surface-container "#2b3b2b")
      (surface-container-high "#263626")
      (surface-container-highest "#2f422f")
      (surface-container-low "#161d16")
      (surface-container-lowest "#0d110d")
      (surface-variant "#223022")
      (tertiary "#85adad")
      (tertiary-container "#2e5151")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#85adad")
      (on-success "#1b221b")
      (success-container "#2e5151")
      (on-success-container "#e1eaea")
      ;; Map fixed colors to regular colors
      (primary-fixed "#8bc18b")
      (primary-fixed-dim "#2f6a2f")
      (secondary-fixed "#81b199")
      (secondary-fixed-dim "#2c5440")
      (tertiary-fixed "#85adad")
      (tertiary-fixed-dim "#2e5151")
      (on-primary-fixed "#1b221b")
      (on-primary-fixed-variant "#e0ebe0")
      (on-secondary-fixed "#1b221b")
      (on-secondary-fixed-variant "#e1eae6")
      (on-tertiary-fixed "#1b221b")
      (on-tertiary-fixed-variant "#e1eaea")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f2f3f2")
      (inverse-primary "#8bc18b")
      (inverse-surface "#1a231a")
