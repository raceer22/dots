...
(let* ((bg "#1a1f23")
      ...
      (on-secondary "#1b1f22")
      (on-secondary-container "#e0e1eb")
      (on-surface "#f2f2f3")
      (on-surface-variant "#afb3b6")
      (on-tertiary "#1b1f22")
      (on-tertiary-container "#e5e0eb")
      (outline-color "#606a70")
      (outline-variant "#5c6b75")
      (primary "#bed0dc")
      (primary-container "#487da0")
      (secondary "#c1c3d9")
      (secondary-container "#4f5599")
      (shadow "#1a1f23")
      (surface "#1a1f23")
      (surface-container "#2b343b")
      (surface-container-high "#262f36")
      (surface-container-highest "#2d3a43")
      (surface-container-low "#161a1d")
      (surface-container-lowest "#0d1011")
      (surface-variant "#212a30")
      (tertiary "#cbc1d9")
      (tertiary-container "#6e4f99")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#cbc1d9")
      (on-success "#1b1f22")
      (success-container "#6e4f99")
      (on-success-container "#e5e0eb")
      ;; Map fixed colors to regular colors
      (primary-fixed "#bed0dc")
      (primary-fixed-dim "#487da0")
      (secondary-fixed "#c1c3d9")
      (secondary-fixed-dim "#4f5599")
      (tertiary-fixed "#cbc1d9")
      (tertiary-fixed-dim "#6e4f99")
      (on-primary-fixed "#1b1f22")
      (on-primary-fixed-variant "#000000")
      (on-secondary-fixed "#1b1f22")
      (on-secondary-fixed-variant "#e0e1eb")
      (on-tertiary-fixed "#1b1f22")
      (on-tertiary-fixed-variant "#e5e0eb")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f2f2f3")
      (inverse-primary "#bed0dc")
      (inverse-surface "#1a1f23")
