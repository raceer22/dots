...
(let* ((bg "#231a1b")
      (err "#b82528")
      (err-container "#3d0f10")
      (on-background "#f3f2f2")
      (on-err "#e2d8d7")
      (on-err-container "#ecdfdf")
      (on-primary "#221b1b")
      (on-primary-container "#ebe0e1")
      (on-secondary "#221b1b")
      (on-secondary-container "#ebe5e0")
      (on-surface "#f3f2f2")
      (on-surface-variant "#b6afaf")
      (on-tertiary "#221b1b")
      (on-tertiary-container "#ebeae0")
      (outline-color "#746364")
      (outline-variant "#7a6163")
      (primary "#d5777e")
      (primary-container "#7b1f26")
      (secondary "#c7916b")
      (secondary-container "#623a1e")
      (shadow "#231a1b")
      (surface "#231a1b")
      (surface-container "#3b2b2c")
      (surface-container-high "#362627")
      (surface-container-highest "#432d2f")
      (surface-container-low "#1d1617")
      (surface-container-lowest "#110d0e")
      (surface-variant "#302123")
      (tertiary "#c2bc70")
      (tertiary-container "#5e5a21")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#c2bc70")
      (on-success "#221b1b")
      (success-container "#5e5a21")
      (on-success-container "#ebeae0")
      ;; Map fixed colors to regular colors
      (primary-fixed "#d5777e")
      (primary-fixed-dim "#7b1f26")
      (secondary-fixed "#c7916b")
      (secondary-fixed-dim "#623a1e")
      (tertiary-fixed "#c2bc70")
      (tertiary-fixed-dim "#5e5a21")
      (on-primary-fixed "#221b1b")
      (on-primary-fixed-variant "#ebe0e1")
      (on-secondary-fixed "#221b1b")
      (on-secondary-fixed-variant "#ebe5e0")
      (on-tertiary-fixed "#221b1b")
      (on-tertiary-fixed-variant "#ebeae0")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f3f2f2")
      (inverse-primary "#d5777e")
      (inverse-surface "#231a1b")
